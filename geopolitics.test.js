...
(async function run() {
  // --- computeLevel(): Stufenlogik isoliert pruefen ---
  {
    ...
    console.log("Block 1/24 (Stufenlogik): OK");
  }
  ...
  // --- UCDP liefert Laender, GDELT antwortet fuer alle -> kombinierte Stufe ---
  {
    ...
    console.log("Block 2/24 (UCDP-Normalfall, kombinierte Signale): OK");
  }
  ...
  // --- UCDP faellt komplett aus -> trotzdem Bericht mit fester Watchlist ---
  {
    ...
    console.log("Block 3/24 (UCDP-Ausfall, feste Liste als Basis, ReliefWeb standardmaessig uebersprungen): OK");
  }
  ...
  // --- Zeitbudget: haengende GDELT-Aufrufe duerfen den Bericht nicht blockieren ---
  {
    ...
    console.log("Block 4/24 (Zeitbudget schuetzt vor Timeout-Sturm): OK");
  }
  ...
  //     die frueher hartkodierte Version "24.01.24" hat nie existiert. ---
  {
    ...
    console.log("Block 5/24 (UCDP: laeuft ueber 404er rueckwaerts bis zur existierenden Monatsversion): OK");
  }
  ...
  // --- Zeitbudget gilt AB FUNKTIONSSTART, nicht erst nach UCDP ---
  {
    ...
    console.log("Block 6/24 (Zeitbudget ab Funktionsstart, deckt UCDP + GDELT zusammen ab): OK");
  }
  ...
  // --- UCDP: unbekannte Laendernamen werden uebersprungen, nicht abgestuerzt ---
  {
    ...
    console.log("Block 7/24 (UCDP: unbekannte Laendernamen werden uebersprungen): OK");
  }
  ...
  // --- UCDP: Ereignis-Array wird unabhaengig vom Antwort-Umschlag gefunden ---
  {
    ...
    console.log("Block 8/24 (UCDP: Ereignis-Array wird umschlagunabhaengig gefunden): OK");
  }
  ...
  // --- ReliefWeb wird OHNE RELIEFWEB_APPNAME gar nicht erst angefragt ---
  {
    ...
    console.log("Block 9/24 (ReliefWeb standardmaessig uebersprungen ohne Appname): OK");
  }
  ...
  // --- MIT RELIEFWEB_APPNAME: ReliefWeb ergaenzt ein von UCDP bereits bekanntes Land ---
  {
    ...
    console.log("Block 10/24 (ReliefWeb ergaenzt ein UCDP-Land, ohne dessen Flags zu verdraengen): OK");
  }
  ...
  // --- MIT RELIEFWEB_APPNAME: ReliefWeb fuegt ein Land hinzu, das UCDP nicht kennt ---
  {
    ...
    console.log("Block 11/24 (ReliefWeb fuegt ein UCDP-unbekanntes Land hinzu): OK");
  }
  ...
  // --- MIT RELIEFWEB_APPNAME: 410 beendet die ReliefWeb-Kette sofort ---
  {
    ...
    console.log("Block 12/24 (ReliefWeb: 410 beendet die Kette sofort): OK");
  }
  ...
  // --- country.iso2 entfernt, Appname konfigurierbar (Live-Befund) ---
  {
    ...
    delete process.env.RELIEFWEB_APPNAME;
    console.log("Block 13/24 (country.iso2 entfernt, Appname aus RELIEFWEB_APPNAME uebernommen): OK");
  }
  ...
  // --- Unbekannter GDELT-/ReliefWeb-Fehler wird sichtbar, nicht verschluckt ---
  {
    ...
    console.log("Block 14/24 (unbekanntes ReliefWeb-Antwortformat wird gemeldet, nicht verschluckt): OK");
  }
  ...
  // --- GDELT: mehr Schlagzeilen, laengerer Zeitraum, Trendverlauf wird angehaengt ---
  {
    ...
    console.log("Block 15/24 (GDELT: mehr Schlagzeilen, 7-Tage-Fenster, Trendverlauf angehaengt): OK");
  }
  ...
  // --- GDELT: schlaegt NUR der Trend-Abruf fehl, bleiben Schlagzeilen/Anzahl unberuehrt ---
  {
    ...
    console.log("Block 16/24 (GDELT: Trend-Abruf ist best-effort, Schlagzeilen bleiben unberuehrt bei dessen Fehlschlag): OK");
  }
  ...
  // --- findGdeltTimelineData: erkennt die Zeitreihe unabhaengig vom Umschlag ---
  {
    ...
    console.log("Block 17/24 (findGdeltTimelineData: umschlagunabhaengig, grenzt sich von der Artikel-Form ab): OK");
  }
  ...
  //     und GDELT kaeme nie zum Zug. Nach dem ersten Timeout muss Schluss sein. ---
  {
    ...
    console.log("Block 18/24 (UCDP: Timeout beendet die Versionssuche sofort, statt sie durchzulaufen): OK");
  }
  ...
  //     die GDELT fuer die Laenderabfragen braucht. ---
  {
    ...
    console.log("Block 19/24 (UCDP: Versionssuche respektiert ihr eigenes Teilbudget): OK");
  }
  ...
  //     kurzlebigen Instanzen waere das viel verschenkte Zeit. ---
  {
    ...
    console.log("Block 20/24 (UCDP: erfolgreiche Version wird gemerkt, zweiter Lauf spart die 404-Kaskade): OK");
  }
  ...
  //     bleibt "nicht geprueft". Deshalb hier festgenagelt. ---
  {
    ...
    console.log(`Block 21/24 (Budgets passen: ${laender} Laender in ${wellen} Wellen = ${gdeltKosten}ms von ${FUNCTION_BUDGET_MS}ms): OK`);
  }
  ...
  //     Laender geholt, die eine offizielle Quelle als Konfliktland fuehrt. ---
  {
    ...
    console.log(`Block 22/24 (GDELT: hoechstens ${maxGleichzeitig} gleichzeitige Anfragen, Trend nur fuer Konfliktlaender): OK`);
  }
  ...
  //     nur Zeit kosten, die GDELT fuer die Laenderabfragen braucht. ---
  {
    ...
    console.log("Block 23/24 (ohne UCDP-Token wird gar nicht erst angefragt, Meldung nennt den Weg zum Token): OK");
  }
  ...
  // --- Mit Token: der Header MUSS gesetzt werden, sonst antwortet die API 401 ---
  {
    ...
    console.log("Block 24/24 (mit Token wird der Header x-ucdp-access-token gesetzt): OK");
  }
